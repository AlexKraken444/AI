...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        self.json_response(200, {"ok": True, "model": "Qwen3 4B · GPU", "type": "causal transformer", "external_ai": False, "memory": "browser-owned per-request context"})
    ...
    def do_POST(self):
        ...
        try:
            ...
            if mode not in ("local", "context", "context3", "context4", "reference"):
